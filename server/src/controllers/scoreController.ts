...
//             console.log(
//               `Processing ${scoreData.lab_sessions.length} lab sessions for student ${scoreData.studentId}`
//             );
...
//               console.log(
//                 `Found ${labSessionQuestions.length} lab sessions in question format for student ${scoreData.studentId}`
//               );
...
//                 });
//                 console.log(
//                   `Question-based lab session ${index}: date=${sessionDate}, marks=${obtainedMarks}`
//                 );
//               });
//             }
//           }
...
//             console.log(
//               `Adding ${processedLabSessions.length} lab sessions to updateData`
//             );
//           }
//           console.log(`Final updateData for student ${scoreData.studentId}:`, {
//             ...updateData,
//             hasLabSessions: processedLabSessions.length > 0,
//             totalLabSessions: processedLabSessions.length,
//           });
